...
import com.example.habittrackerapp.worker.ReminderWorker
import com.example.habittrackerapp.worker.WeeklySummaryWorker
...
object NotificationHelper {    // Declaramos el objeto de helper de notificaciones
    ...
    fun crearCanal(context: Context) {
        val canal = NotificationChannel(
            CANAL_ID,
            context.getString(com.example.habittrackerapp.R.string.notif_channel_name),
            NotificationManager.IMPORTANCE_DEFAULT
        ).apply {
            description = context.getString(
                com.example.habittrackerapp.R.string.notif_channel_description
            )
        }
