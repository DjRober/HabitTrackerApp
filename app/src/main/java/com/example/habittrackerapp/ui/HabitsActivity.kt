...
class HabitsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = HabitAdapter(habits) { habit ->
            // Importante: Más opciones -> pendientes a implementar
        }
    ...
    // Generamos los ultimos siete días de forma dinámica
    ...
    // Creamos datos de prueba (se reemplazarán con FireBase):
